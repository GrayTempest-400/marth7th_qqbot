...
def modelAnalysis(model_path,config_path,device, enhance):
    global model
...
def vc_infer(output_format, sid, audio_path, truncated_basename, vc_transform, auto_f0, cluster_ratio, slice_db, noise_scale, pad_seconds, cl_num, lg_num, lgr_num, f0_predictor, enhancer_adaptive_key, cr_threshold, k_step, use_spk_mix, second_encoding, loudness_envelope_adjustment):
    ...
    output_file_name = 'mar7th_tts'+f'.{output_format}'
...
def tts(text):
    ...
    try:
        ...
        input_audio = "tts.wav"
        f0_predictor = "mp"
        model_path = "trained/mar7th_G_40000.pth"
        config_path = "trained/mar7th.json"
        ...
        modelAnalysis(model_path,config_path,device, enhance)
